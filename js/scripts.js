jQuery(document).ready(function() {
	jQuery("div.social_bookmark, li.social_bookmark").hover(function() {
		var p = jQuery(this);
		var i = 0;
		
		do {
			if ( p.children("div.social_bookmark_extra").size() ) {
				p.children("div.social_bookmark_extra").each(function() {
					var t = jQuery(this);
					...
					setTimeout(function() {
						if ( !t.data('doFadeOut') && t.data('doFadeIn') === t.data('doFadeToken') ) {
							var r = p.children("div.social_bookmark_ruler");
							...
							if ( r.offset().top + t.height() + 12 > w.height() + w.scrollTop() ) {
								t.css('top', p.children("div.social_bookmark_services").offset().top - t.height() - 12);
							}
